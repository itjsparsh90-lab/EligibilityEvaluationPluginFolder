    ...
    ITracingService tracing)
        {
            ...
            foreach (var bliId in ids)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    // give a minimal resultJson so dialog doesn�t break
    ...
    string evalContextJson)
        {
            ...
            if (validationFailures.Count > 0)
            {
                ...
                // ✅ NEW: include summaryFacts so batch dropdown label works
                var summaryFactsFail = BuildMinimalSummaryFactsForValidationFailure(service, tracing, bli);
                ...
                TryCreateEligibilityNote(
                    ...
                    evalLines: null,
                    groupEvals: null,
                    summaryFacts: summaryFactsFail   // ✅ NEW (optional but recommended)
                );
            ...
            if (caseRef != null)
            {
                ...
                // these don�t need context at all (your code already doesn�t use it)
     ...
     ITracingService tracing = null)
        {
            ...
            var taxMissing = GetFactString(facts, "docs.tax.missingNames");   // ✅ NEW
            ...
            foreach (var line in lines)
            {
                ...
                {
                    line.actual = AppendActual(line.actual, "Missing: " + taxMissing); // ✅ NEW
                }
            }
